...
export default function Nav({ className, routes }) {
  ...
  return (
    <nav
      id="nav"
      className={`${className} flex flex-row my-4 mx-auto z-10 sticky top-0 p-2 bg-opacity-25 backdrop-blur-sm shadow-xl transition-transform duration-300 ease-in-out`}
